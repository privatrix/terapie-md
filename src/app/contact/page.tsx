                        ...
                        <div className="grid gap-4 sm:grid-cols-2">
                            <div className="space-y-2">
                                ...
                                <input
                                    ...
                                    required
                                    onInvalid={(e) => (e.target as HTMLInputElement).setCustomValidity("Te rugăm să completezi acest câmp.")}
                                ...
                                <input
                                    ...
                                    onInvalid={(e) => {
                                        ...
                                        if (target.validity.valueMissing) {
                                            target.setCustomValidity("Te rugăm să completezi acest câmp.");
