            ...
            <div className="p-8 flex flex-col h-full relative z-10">
                ...
                <div className="space-y-3 mb-6 flex-grow">
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                        Promovează-ți serviciile și evenimentele direct către publicul țintă.
                    </p>
                </div>

                {/* Benefits / Tags */}
                <div className="flex flex-wrap gap-2 mb-8">
                    {["Promovare", "Evenimente", "Sales"].map((tag) => (
                ...
                <div className="mt-auto">
                    <Button className="w-full h-11 text-base shadow-sm group-hover:shadow-md transition-all hover:bg-primary hover:text-white" variant="outline" asChild>
                        <Link href="/business/register" className="flex items-center justify-center gap-2">
                            Înregistrează Business
                        </Link>
                    </Button>
                </div>
            </div>
