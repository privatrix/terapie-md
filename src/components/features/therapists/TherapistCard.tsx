...
export function TherapistCard({ therapist }: { therapist: TherapistProps }) {
    ...
    return (
        <div className={`group relative flex flex-col overflow-hidden rounded-xl border bg-card text-card-foreground shadow-sm transition-all ${isPlaceholder ? 'opacity-80' : 'hover:shadow-md'}`}>
